...
<div class="w3-panel w3-padding-64 w3-teal w3-display-topmiddle " style="min-width:400px">
        ...
        {
          $sql = "UPDATE Stadium SET stadium_place = ".$_POST["stadium_place"].",  stadium_country =  ".$_POST["stadium_country"].",  
          stadium_capacity = ".$_POST["stadium_capacity"]." where stadium_name =   ".$_POST["stadium_name"]." ";
