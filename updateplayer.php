...
<div class="w3-panel w3-padding-64 w3-teal w3-display-topmiddle " style="min-width:400px">
         <?php
          ...
          {
            $sql = "UPDATE player SET player_name = ".$_POST["player_name"].",  team_name =  ".$_POST["team_name"].",  
            player_DOB = ".$_POST["player_DOB"].",  player_first_match =  ".$_POST["player_first_match"]." where player_id =   ".$_POST["player_id"]." ";
