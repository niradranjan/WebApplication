...
<div class="w3-panel w3-padding-64 w3-teal w3-display-topmiddle " style="min-width:400px">
          ...
          $conn = new mysqli(DB_HOST, DB_USERNAME, DB_PASSWORD, DB_DATABASE); if(isset($_POST['insert_team']));
            ...
            {
              $sql = "INSERT INTO  player (player_id, player_name, team_name, player_DOB, player_first_match)
               VALUES ('".$_POST["player_id"]."','".$_POST["player_name"]."','".$_POST["team_name"]."','".$_POST["player_DOB"]."','".$_POST["player_first_match"]."' )";
