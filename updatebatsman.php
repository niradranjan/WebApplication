...
<div class="w3-panel w3-padding-64 w3-teal w3-display-topmiddle " style="min-width:400px">
        <?php
          ...
          $conn = new mysqli(DB_HOST, DB_USERNAME, DB_PASSWORD, DB_DATABASE); if(isset($_POST['insert_team']));
            ...
            if(isset($_POST['update_batsman']))
            {
               $sql = "UPDATE batsman SET matches_played = ".$_POST["matches_played"].",  runs_scored =  ".$_POST["runs_scored"].",  balls_faced = ".$_POST["balls_faced"]."                where batsman_id =   ".$_POST["batsman_id"]." ";
