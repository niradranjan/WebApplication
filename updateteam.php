...
<div class="w3-panel w3-padding-64 w3-teal w3-display-topmiddle " style="min-width:400px">
         <?php
          ...
          if(isset($_POST['update_team']))
          {
            ...
            $sql = "UPDATE team SET team_rank = ".$_POST["team_rank"].",  matches_played =  ".$_POST["matches_played"].",  matches_won = ".$_POST["matches_won"]." ,  
            matches_lost = ".$_POST["matches_lost"]." ,  matches_tied = ".$_POST["matches_tied"]." where team_name =   ".$_POST["team_name"]." ";
