...
<div class="w3-panel w3-padding-64 w3-teal w3-display-topmiddle " style="min-width:400px">
          ...
          {
            $sql = "UPDATE bowler SET matches_played = ".$_POST["matches_played"].",  runs_conceded =  ".$_POST["runs_conceded"].",  wickets_taken = ".$_POST["wickets_taken"]."                where bowler_id =   ".$_POST["bowler_id"]." ";
