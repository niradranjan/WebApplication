...
<div class="w3-panel w3-padding-64 w3-teal w3-display-topmiddle " style="min-width:400px">
        ...
        <?php 
          ...
          $conn = new mysqli(DB_HOST, DB_USERNAME, DB_PASSWORD, DB_DATABASE);
            ...
            {
              $sql = "INSERT INTO  batsman (batsman_id, matches_played, runs_scored, balls_faced);
              VALUES ('".$_POST["batsman_id"]."','".$_POST["matches_played"]."','".$_POST["runs_scored"]."','".$_POST["balls_faced"]."')";
