...
?>
      ...
      <div class="w3-row-padding w3-padding-32" style="margin:0 -16px">
        <div class="w3-third w3-margin-bottom">
          ...
          <div class="w3-container w3-white">
            ...
            <button class="w3-button w3-black w3-margin-bottom" onclick="document.getElementById('teamRecordsModal').style.display='block'">Click here</button>
          </div>
        </div>
        <div class="w3-third w3-margin-bottom">
          ...
          <div class="w3-container w3-white">
            ...
            <button class="w3-button w3-black w3-margin-bottom" onclick="document.getElementById('batsmanRecordsModal').style.display='block'">Click here</button>
          </div>
        </div>
        <div class="w3-third w3-margin-bottom">
          ...
          <div class="w3-container w3-white">
            ...
            <button class="w3-button w3-black w3-margin-bottom" onclick="document.getElementById('bowlerRecordsModal').style.display='block'">Click here</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div id="batsmanRecordsModal" class="w3-modal" style = "width:100%">
    <div class="w3-modal-content w3-animate-top w3-card-4">
        <span onclick="document.getElementById('teamRecordsModal').style.display='none'" 
       class="w3-button w3-teal w3-small w3-display-topright">×</span>
      </header>
  ...
  <div id="bowlerRecordsModal" class="w3-modal" style = "width:100%">
    <div class="w3-modal-content w3-animate-top w3-card-4">
        <span onclick="document.getElementById('teamRecordsModal').style.display='none'" 
       class="w3-button w3-teal w3-small w3-display-topright">×</span>
      </header>
