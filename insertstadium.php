...
<body>
  <div class="w3-panel w3-padding-64 w3-teal w3-display-topmiddle " style="min-width:400px">
        ...
        DEFINE('DB_USERNAME', 'root');
          ...
          if(isset($_POST['insert_stadium']))
          {
            $sql = "INSERT INTO  Stadium (stadium_name, stadium_place, stadium_country, stadium_capacity)
            VALUES ('".$_POST["stadium_name"]."','".$_POST["stadium_place"]."','".$_POST["stadium_country"]."','".$_POST["stadium_capacity"]."')";
